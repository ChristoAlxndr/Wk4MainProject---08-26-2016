...
public class ZooMethods {
	...
	public static void writeToDB() {
		...
		try {
			...
			PREP_STMT.setInt(6, animalToAdd.getAge());
	...
	public static void deleteFullInfo() {
		...
		try {
			...
			PREP_STMT.setDouble(5, animalToDelete.getWeight());
			PREP_STMT.setInt(6, animalToDelete.getAge());
	...
	private static Animals aboutTheAnimal() {
		...
		animalToAdd.setWeight(Double.parseDouble(scan.nextLine()));

		System.out.println("What is the animal's age?");
		animalToAdd.setAge(Integer.parseInt(scan.nextLine()));
